<template>
  ...
  <div class="backdrop-blur-xl bg-white/80 p-6 rounded-xl border border-teal-950/10">
    ...
    <form @submit.prevent="submitForm" class="space-y-3">
      ...
      <div class="flex justify-between pt-2"><span>Price:</span><span>${{ totalPrice.toFixed(2) }}</span></div>

      <div class="flex justify-between pb-3"><span>Order Discount:</span><span>-${{ (totalPrice * 0.40).toFixed(2) }}</span></div>
